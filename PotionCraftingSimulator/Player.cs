    ...
    internal class Player : Person
    {
        ...
        public Player()
        {
            Inventory = new List<Item>
            {
                ...
                new() {ItemName = "Dried Lavender", ItemDescription = "A purple flower commonly used to treat insomnia.", ItemValue = .55, ItemAmount = 1/2, ItemAmountType = "tsp"},
                new() {ItemName = "Lemon Balm", ItemDescription = "A lemony-scented herb commonly used to reduce stress and treat insomnia and/or anxiety.", ItemValue = .40, ItemAmount = 1/2, ItemAmountType = "tsp"},
                ...
                new() {ItemName = "Dried St. John's Wort", ItemDescription = "A medicinal herb commonly used to promote wound healing.", ItemValue = .85, ItemAmount = 1/2, ItemAmountType = "tsp"},
                ...
                new() {ItemName = "Dried Sage", ItemDescription = "An aromatic herb that can increase brain function in areas related to memory and attention.", ItemValue = .35, ItemAmount = 3/4, ItemAmountType = "tsp"}, 
                ...
                new() {ItemName = "Cinnamon", ItemDescription = "A spicy tasting herb to ~spice~ up your romance.", ItemValue = .40, ItemAmount = 1/2, ItemAmountType = "tsp"},
